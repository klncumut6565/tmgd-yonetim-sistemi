...
export const BELGE_SABLONLARI: Record<string, BelgeSablonu> = {
  ...
  P2: {
    ...
    blocks: [
      ...
      { type: "subheading", text: "1.1. Tehlikeli Madde Tanımlaması ve Risk Analizi" },
      { type: "bullet", items: [
        "Taşınan tehlikeli maddenin sınıfı ve risk özellikleri belirlenmelidir.",
      ]},
      { type: "subheading", text: "1.2. Taşıma Belgelerinin ve Etiketlemenin Kontrolü" },
      { type: "bullet", items: [
        "Taşıma belgeleri ve etiketler kontrol edilmelidir.",
      ]},
      { type: "subheading", text: "1.3. Eğitim ve Personel Hazırlığı" },
      { type: "bullet", items: [
        "Boşaltma işlemine katılacak tüm personel, ilgili düzenlemelere uygun eğitim almalıdır.",
      ]},
      { type: "subheading", text: "1.4. Güvenlik Ekipmanlarının Kontrolü" },
      { type: "bullet", items: [
        "Yangın söndürücüler, gaz dedektörleri ve koruyucu ekipmanlar kontrol edilmelidir.",
      ]},
      { type: "subheading", text: "1.5. Boşaltma Alanının Hazırlığı" },
      { type: "bullet", items: [
      ...
      { type: "subheading", text: "5.2. Taşıma Araçlarının Temizliği ve Dezenfekte Edilmesi" },
      { type: "bullet", items: [
      ...
      { type: "subheading", text: "5.3. Tank, Taşıt veya Konteynerin Dışına Bulaşan Maddelerin Arındırılması" },
      { type: "bullet", items: [
      ...
      { type: "subheading", text: "5.4. Tehlike İkaz Levhalarının Kaldırılması" },
      { type: "bullet", items: [
  ...
  P4: {
    ...
    blocks: [
      ...
      { type: "subheading", text: "1. Sınıf: Patlayıcılar" },
      { type: "subheading", text: "2. Sınıf: Gazlar" },
      { type: "subheading", text: "3. Sınıf: Yanıcı sıvılar" },
      { type: "subheading", text: "4. Sınıf: Yanıcı katılar, kendiliğinden tutuşan maddeler" },
      { type: "subheading", text: "5. Sınıf: Oksitleyici maddeler ve organik peroksitler" },
      { type: "subheading", text: "6. Sınıf: Zehirli ve bulaşıcı maddeler" },
      { type: "subheading", text: "7. Sınıf: Radyoaktif maddeler" },
      { type: "subheading", text: "8. Sınıf: Aşındırıcı maddeler" },
      { type: "subheading", text: "9. Sınıf: Diğer tehlikeli maddeler" },
      { type: "bullet", items: [
  ...
  SA2: {
    ...
    blocks: [
      ...
      { type: "subheading", text: "1. Karışık Yükleme ve Ayrım Denetimleri (ADR 7.5.2)" },
